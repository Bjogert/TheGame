...
- Step 10 (OpenAI dialogue integration) landed: the broker now calls the live OpenAI Chat Completions API when `OPENAI_API_KEY` is provided, automatically falling back to deterministic local replies otherwise.
